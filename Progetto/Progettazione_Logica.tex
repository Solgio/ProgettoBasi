...
In TRACKING invece è necessario che tutte le \textit{DataOra} siano successive alla \textit{DataOra} di creazione del pacco. Tale controllo non sono stati implementati in SQL, per mancanza di conoscenze necessarie.\\
\begin{figure}[H]
\centering
